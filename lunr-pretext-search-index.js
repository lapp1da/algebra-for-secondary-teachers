...
{
  "id": "sec12-ccss-content-overview",
  "level": "1",
  "url": "sec12-ccss-content-overview.html",
  "type": "Section",
  "number": "1.2",
...
},
{
  ...
  "level": "1",
  "url": "sec13-ccss-mathematical-practice.html",
  "type": "Section",
  "number": "1.3",
  "title": "Common Core State Standards for Mathematics: Standards for Mathematical Practice",
  "body": " Common Core State Standards for Mathematics: Standards for Mathematical Practice  Text of section.  "
},
{
...
},
{
  ...
  "body": " Extending the Number System: Complex Numbers   Throughout history, our number system has evolved primarily driven by necessity. It should come as no surprise that our current system (the complex numbers) was also driven by an issue with the real number system. On of the motivators was the search for real solutions to equations, in particular, polynomial equations. The solution to the general quadratic equation, , had beeen established as but there was still some concern with the situation for when there ended up to be a negative under the radical.  However, there was still a search for a solution to the general cubic, . At the time, the solution to some forms of the cubic had been found. For example, if a cubic was in the form, , where the squared term was not present, Ferro had found a way to solve it, but general cubic was still out of reach.     "
},
{
  "id": "sec23-intro-vectors-matrices",
  "level": "1",
  "url": "sec23-intro-vectors-matrices.html",
  "type": "Section",
  "number": "2.3",
  "title": "Introduction to Vectors and Matrices",
  "body": " Introduction to Vectors and Matrices  Text of section.  "
},
{
  "id": "backmatter-2",
  "level": "1",
